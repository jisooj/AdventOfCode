 ...
 * that detects a start-of-packet marker in the datastream. In the protocol being used by the 
 * Elves, the start of a packet is indicated by a sequence of four characters that are all different.
 * 
